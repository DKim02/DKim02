...
![image](https://github.com/user-attachments/assets/56385999-008b-42c0-b86e-83f6a434d3d4)

** 위의 파일들은 법적인 문제(배포 금지)와, 용량으로 인해 업로드를 하지 않았습니다.

** 위에서 아래로 순서대로 설명드리자면,

** d0c0df48bf2b2c9350dd855021a5b216f560c0c7디렉토리는 KoGPT2 모델입니다. (해당 파일은 레퍼런스를 참고해주세요)

** dataset디렉토리는 random_sample.py에 의해 생성되는 데이터셋인 random_sample.json과 국립국어원의 맞춤법 교정 말뭉치파일이 있습니다.(해당 파일은 레퍼런스를 참고해주세요)

** ET5_model디렉토리는 ET5모델입니다. (해당 파일은 레퍼런스를 참고해주세요)

** fine_tuned_model디렉토리는 파인튜닝된 ET5모델이 저장되는 장소입니다.

** hanspell은 hanspell 모듈을 사용하기 위해 로컬로 다운을 받았습니다. (해당 파일은 레퍼런스를 참고해주세요)
